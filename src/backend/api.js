module.exports = function(app) {
  let cars = [
    ...
    {'id':3, 'img':'/assets/images/silverado.jpg', 'name':'Chevrolet | Silverado', 'make':'Chevrolet', 'model':'Silverado', 'availability':'Available'},
    ...
    {'id':9, 'img':'/assets/images/elantra.jpg', 'name':'Hyundai | Elantra', 'make':'Hyundai', 'model':'Elantra', 'availability':'Available'}];
